...
Message=Text(raiz,width=50, height=10)#Label para mostrar lo que el usuario ha seleccionado
...
pelicula.current(0)#sirve para que aparezca una opcion por defecto en el combobox, se le pone la posicion del valor que quiero que salga
...
Enviarboton=Button(raiz,width=10, text="Mostrar", command=MostrarDatos)#crea un boton con texto dentro y se le pasa la funcion boton1
